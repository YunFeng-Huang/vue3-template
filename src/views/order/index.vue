  ...
  <div class="top-search-main">
    ...
    <template v-if="data.length > 0">
      ...
      >
        ...
        <el-table-column prop="name" label="订单字段"></el-table-column>
  ...
  setup() {
    ...
    const onSubmit = () => {
      ...
      proxy.$api.Order.order({
        ...
        .then(
          ({
            paymentAlipayTradeFastpayPayRefundQueryResponse,
            paymentWeixinMerchantPayRefundQueryResponse,
            paymentAlipayTradeFastpayPayRefundQueryNotes,
            paymentWeixinMerchantPayRefundQueryNotes,
          }) => {
            ...
            let datatext = paymentAlipayTradeFastpayPayRefundQueryResponse
              ? paymentAlipayTradeFastpayPayRefundQueryNotes
              : paymentWeixinMerchantPayRefundQueryNotes;

            orderData.oldaliOrderQueryResult = JSON.stringify(data);
            ...
            for (const key in data) {
              if (Object.prototype.hasOwnProperty.call(data, key)) {
                ...
                o = {
                  ...
                  key: key,
                  name: datatext[key],
                  value: Array.isArray(element) ? "" : JSON.stringify(element),
                  children: [],
                };
            ...
            orderData.data = aliOrderQueryResultList;
          }
        )
        .catch((v) => {
          orderData.loading = false;
